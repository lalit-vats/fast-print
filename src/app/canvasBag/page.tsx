    ...
    return (
        <div className='mt-15'>
            <div className='relative'>
                ...
                <h1 className='mb-1.5 w-full text-white absolute  z-10 top-1/3  text-center  text-6xl font-bold md:text-8xl'>Canvas Bag</h1>
            </div>
            <div className='container mx-auto md:px-40 grid grid-cols-1 md:grid-cols-2 p-4 md:py-6 gap-3.5'>
                <div className='relative'>
                    <Image src={BigImage} alt='Canvas Bag print in delhi' className='rounded-xl animate__fadeInDown' />
                    <Image src={SmallImage} alt='Canvas Bag printing fastprint' className='hidden md:block rounded-xl absolute z-20 -bottom-6 right-4 shadow-2xl' />
                </div>
