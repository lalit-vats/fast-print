...
export const metadata: Metadata = {
  ...
  keywords: [
    "Fast Print Folder Print",
    "Folder Printing in Munirka",
    "Folder Print in Delhi",
    "Folder Printing in Gurgaon",
    "Folder Print near me",
  ],
}
...
const FolderPrint
  = () => {
    ...
    return (
      <div className='mt-15'>
        <Script
          id="folder-print-schema"
          type="application/ld+json"
          strategy="beforeInteractive"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(folderSchema) }}
        />
        <div className='relative'>
          <Image src={BgImage} alt='fastprint we make custom folder ' className='w-full h-full object-cover ' />
        ...
        <div className='container mx-auto md:px-40 grid grid-cols-1 md:grid-cols-2 p-4 md:py-6 gap-3.5'>
          <div className='relative'>
            <Image src={BigImage} alt='custom folder print delhi' className='rounded-xl' />
            <Image src={SmallImage} alt='office folder print in delhi' className='hidden md:block rounded-xl absolute z-20 -bottom-6 right-4 shadow-2xl' />
          </div>
