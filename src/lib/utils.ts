...
export const serviceLink = [
  ...
  { name: "T-Shirt Print", href: "/tshirt-print-delhi" },
  { name: "Mug Print", href: "/mug-print-delhi" },
  { name: "Vinyl Print", href: "/vinyl-print-delhi" },
  { name: "Hording-Banner Print", href: "/hording-print-delhi" },
  { name: "Broucre Print", href: "/broucre-print-delhi" },
  { name: "Standee Print", href: "/standee-print-delhi" },
  { name: "Canopy", href: "/canopy-in-delhi" },
  { name: "Pamphlet Print", href: "/pamphlet-print-delhi" },
  { name: "Letterhead Print", href: "/letterhead-print-delhi" },
